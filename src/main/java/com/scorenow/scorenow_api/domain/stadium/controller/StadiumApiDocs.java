...
public interface StadiumApiDocs {
    ...
    @Operation(summary = "경기장 ID 로 검색", description = "경기장 ID를 이용하여 특정 경기장을 검색합니다.")
    ApiResponse<List<StadiumResponse>> searchStadiumByStadiumId(
            @Parameter(description = "검색할 경기장 ID", required = true, example = "686") Long id);
