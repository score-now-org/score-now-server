...
public class MatchDetailService {
	...
	public void updateInplayMatchDetail(Match match) {
		...
		if (stadiumData != null) {
			Stadium stadium = stadiumCacheService.getOrCreateStadium(response.getProvider(), apiResult.getSportId(),
				stadiumData.getId(), stadiumData.getName(), stadiumData.getCity());
