...
public class LeagueCacheService {
	 ...
	 */
	public Optional<League> get(ApiProvider provider, String externalLeagueId) {
	 ...
	 * 리그 캐시 삭제
	 */
	public void delete(ApiProvider provider, String externalLeagueId) {
		String cacheKey = generateCacheKey(provider, externalLeagueId);
	 ...
	 * DB 조회 후 캐시 업데이트
	 */
	public Optional<League> refresh(ApiProvider provider, String externalLeagueId) {
	 ...
	 * 리그 Cache Key 생성
	 */
	private String generateCacheKey(ApiProvider provider, String externalLeagueId) {
